package com.zhangym.controller;

import com.alibaba.fastjson.JSONObject;
import com.zhangym.annotation.*;
import com.zhangym.config.ResponseHelper;
import com.zhangym.config.ResponseModel;
import com.zhangym.entity.User;
import com.zhangym.service.IUserService;
...
public class LoginController {
    ...
    @ApiOperation(value="管理员添加用户", notes="body体参数,需要Authorization",produces = "application/json")
    @ApiImplicitParams({
            @ApiImplicitParam(name = "requestJson", value = "{\"username\":\"zhangym\",\"mobile\":\"13888888888\",</br>" +
                    "\"password\":\"123456\",</br>\"rePassword\":\"123456\",\"job\":\"java开发\"," +
                    "</br>\"unit(可不传)\":\"xxx公司\"}"
                    , required = true, dataType = "String",paramType="body")
    })
    ...
    public ResponseModel register(
            ...
            @CurrentUser @ApiIgnore User user) throws Exception{
